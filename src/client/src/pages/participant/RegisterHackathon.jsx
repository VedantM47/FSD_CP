  ...
  useEffect(() => {
    const checkRegistrationAndFetchProfile = async () => {
      try {
        ...
        // Fetch hackathon details to get domains
        try {
          const hackathonRes = await getHackathonById(id);
          const hackathonData = hackathonRes.data?.data || hackathonRes.data;
        ...
        >
          ...
          <div className="step-card">
            ...
            <div className="input-grid">
              ...
              <div className="form-group input-full">
                <label>Motivation to join / Project Idea (Optional)</label>
                <textarea
                  name="projectIdea"
                  value={formData.projectIdea}
                  onChange={handleChange}
                  placeholder="Briefly describe what you plan to build or why you're joining..."
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="step-card">
            <div className="step-header">
              ...
              <h2 className="step-label">Invite Team Members</h2>
            </div>
            ...
            >
              ...
              {/* Dropdown */}
              {searchResults.filter((u) => u._id !== currentUser?._id).length >
                0 && (
                <div
            ...
            <div className="input-full" style={{ margin: 0 }}>
              <div className="toggle-box">
                ...
                <div className="toggle-text">
                  ...
                  <span>
                    Your team will be visible to others who are looking to join
                    a team.
                  </span>
                </div>
              </div>
