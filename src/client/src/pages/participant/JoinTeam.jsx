    ...
    try {
      ...
      alert(
        msg.includes("already")
          ? "You have already requested this team or are currently in a team."
          : `Error: ${msg}`,
      );
    } finally {
      setRequesting(null);
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Discover open teams looking for <strong>talented members</strong>.
            </p>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    {(team.teamSkills || []).length > 5 && (
                      <span className="team-skill-tag">
                        +{team.teamSkills.length - 5} more
                      </span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      ...
                      team.members?.find(
                        (m) =>
                          m.userId?._id === user._id && m.status === "pending",
                      ) ? (
                        <button
        ...
        {showJoinModal && (
          ...
          >
            ...
            >
              ...
              >
                Send a short message to the team leader introducing yourself.
              </p>
